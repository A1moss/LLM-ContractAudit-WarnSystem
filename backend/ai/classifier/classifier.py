...
CONTRACT_TYPES = ["采购合同", "销售合同", "买卖合同", "保密合同", "服务合同", "劳动合同"]
...
- 采购合同：买方（甲方）向供应商采购货物/服务，含交付验收、付款条件、质保/售后、供应商管理条款
- 销售合同：卖方（甲方）销售产品或授权经销/代理，含定价、市场推广、渠道管理、回款、代理/经销条款
- 买卖合同：中性的货物买卖/购销，不强调买方或卖方立场，双方为平等交易关系（常见"XX买卖合同/购销合同（示范文本）"）
- 保密合同：以保密义务为核心，约定保密范围、保密期限、违约责任，不涉及交易标的本身
- 服务合同：以提供/委托服务为核心，含服务内容、SLA/服务等级、验收、知识产权归属、外包/委托关系
- 劳动合同：以建立劳动关系为核心，含岗位职责、薪酬福利、竞业限制、社保、离职条款

若同时具备多类特征，按「合同的核心标的」判断。采购/销售/买卖三者难以区分时，看甲方在正文中的立场：
甲方是买方/采购方→采购合同；甲方是卖方/授权方→销售合同；双方无明确买卖方向→买卖合同。
